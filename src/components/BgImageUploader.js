      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
          ...
          >
            ...
            <div className="flex flex-col items-center justify-center h-48 border-2 border-dashed border-blue-400 rounded-lg bg-blue-50 cursor-pointer"
            ...
            >
              ...
              <span className="text-blue-500">拖拽图片到此处，或点击选择文件</span>
              <input
                type="file"
                accept="image/*"
            ...
            <div className="mt-6 flex items-center gap-2">
              ...
              <input type="range" min="0" max="1" step="0.01" value={bgOpacity} onChange={onOpacityChange} className="w-32 align-middle accent-blue-500" />
